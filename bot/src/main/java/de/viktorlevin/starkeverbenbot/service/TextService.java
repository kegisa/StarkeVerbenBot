...
public class TextService {
    ...
    private static final String TOP_RATING_MESSAGE = """
            🎉 Вы входите в топ %d пользователей бота по выученным словам и глаголам за неделю!
                        
            📚 Выучено слов: %d.
            💪 Выучено сильных глаголов: %d.
            🚀 Не останавливайтесь на достигнутом! Вы на правильном пути к совершенству! 🌟
                        
            💖 Если бот помогает вам учиться, вы можете поддержать его развитие:
            🌍/🇺🇦 PayPal https://www.paypal.me/kegisa
            🇷🇺 Переводом на карту Sber 4276540022894061      
            Статистику за все время можно получить по команде /statistic. 
            """;
